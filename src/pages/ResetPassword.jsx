...
export default function ResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.message || translations.failedToResetPassword);
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="relative z-10 animate-scale-in">
          <Card className="w-[420px] shadow-2xl">
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="text-2xl text-success">{translations.resetPasswordSuccess}</CardTitle>
              <CardDescription className="text-base">{translations.resetPasswordSuccessMessage}</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  {translations.resetPasswordEmailSent.replace('{email}', email)}
                </p>
                <p className="text-sm text-muted-foreground">
                  {translations.resetPasswordCheckSpam}
                </p>
              </div>
            </CardContent>
      ...
      <div className="relative z-10 animate-scale-in">
        <Card className="w-[420px] shadow-2xl">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription className="text-base">{translations.resetPasswordDescription}</CardDescription>
          </CardHeader>
          <form onSubmit={handleSubmit}>
            ...
            <CardFooter className="flex flex-col gap-6 pt-2">
              <Button 
                ...
                size="lg"
              >
                {loading ? translations.sendingResetEmail : translations.sendResetEmail}
              </Button>
