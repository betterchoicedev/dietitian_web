...
export default function NutritionAnalytics() {
    ...
    const fetchNutritionData = async () => {
      ...
      try {
        ...
        if (clientProfile && clientProfile.macros) {
          setNutritionTargets({
            dailyTotalCalories: clientProfile.dailyTotalCalories || 0,
  ...
  const calculateTargetAchievements = () => {
    ...
    return {
      calories: nutritionTargets.dailyTotalCalories > 0
        ? Math.round((stats.averages.calories / nutritionTargets.dailyTotalCalories) * 100)
        : 0,
  ...
  const chartDataWithTargets = chartData.map(data => ({
    ...data,
    target_calories: nutritionTargets?.dailyTotalCalories || 0,
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground/70">
                  {stats?.averages.calories || 0} / {nutritionTargets.dailyTotalCalories} {translations.calories || 'cal'}
                </p>
              </div>
