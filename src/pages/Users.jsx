        ...
        <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid gap-6 py-4">
              ...
              {/* Basic Information */}
              <div className="space-y-6">
                <div className={`${language === 'he' ? 'border-r-4 pr-4' : 'border-l-4 pl-4'} border-blue-500`}>
                  <h3 className="text-xl font-semibold text-gray-800">{translations.basicInformation}</h3>
                  <p className="text-gray-600 mt-1">{translations.basicInformationDescription || 'Let\'s start with the essential details about your client'}</p>
                </div>
              ...
              <div className="space-y-6">
                <div className={`${language === 'he' ? 'border-r-4 pr-4' : 'border-l-4 pl-4'} border-green-500`}>
                  <h3 className="text-xl font-semibold text-gray-800">{translations.physicalInformation}</h3>
                  <p className="text-gray-600 mt-1">{translations.physicalInformationDescription || 'Physical details help us create personalized nutrition plans'}</p>
                </div>
              ...
              <div className="space-y-6">
                <div className={`${language === 'he' ? 'border-r-4 pr-4' : 'border-l-4 pl-4'} border-purple-500`}>
                  <h3 className="text-xl font-semibold text-gray-800">{translations.nutritionInformation}</h3>
                  <p className="text-gray-600 mt-1">{translations.nutritionInformationDescription || 'Nutritional targets and meal planning preferences'}</p>
                </div>
              ...
              {/* Meal Plan Structure */}
              <div className="space-y-4">
                <h3 className="text-lg font-medium">{translations.mealPlanStructure || 'Meal Plan Structure'}</h3>
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
